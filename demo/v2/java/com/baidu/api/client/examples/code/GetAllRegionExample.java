...
import com.baidu.api.sem.nms.v2.GetAllRegionRequest;
import com.baidu.api.sem.nms.v2.GetAllRegionResponse;

/**
 * 
 * ClassName: GetAllRegionExample  <br>
 * Function: TODO ADD FUNCTION
 *
 * @author Baidu API Team
 * @date Feb 9, 2012
 */
public class GetAllRegionExample {

	private CodeService service;

	public GetAllRegionExample() {
	...
	public GetAllRegionResponse getAllRegion() {
		...
		GetAllRegionRequest parameters = new GetAllRegionRequest();
		// Invoke the method.
		GetAllRegionResponse ret = service.getAllRegion(parameters);
		...
		if (rheader.getStatus() == 0) {
			System.out.println("result\n" + ObjToStringUtil.objToString(ret.getRegions()));
			return ret;
		} else {
	...
	public static void main(String[] args) throws Throwable {
		GetAllRegionExample example = new GetAllRegionExample();
		example.getAllRegion();
	}
