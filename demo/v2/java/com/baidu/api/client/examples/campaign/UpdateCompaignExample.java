...
import com.baidu.api.sem.nms.v2.UpdateCampaignRequest;
import com.baidu.api.sem.nms.v2.UpdateCampaignResponse;

/**
 * 
 * ClassName: UpdateCompaignExample  <br>
 * Function: TODO ADD FUNCTION
 *
 * @author Baidu API Team
 * @date Feb 9, 2012
 */
public class UpdateCompaignExample {

	private CampaignService service;

	public UpdateCompaignExample() {
	...
	public UpdateCampaignResponse updateCampaign() {
		...
		UpdateCampaignRequest parameters = new UpdateCampaignRequest();
		CampaignType campaign = new CampaignType();
		campaign.setCampaignId(757456l);
		campaign.setCampaignName("TestCampaign");
		campaign.setStartDate(DateTimeUtil.getDate(2012, 3, 10));
		campaign.setEndDate(DateTimeUtil.getDate(2012, 4, 10));
		campaign.setBudget(200);
		campaign.setStatus(1);
		parameters.getCampaignTypes().add(campaign);
		// Invoke the method.
		UpdateCampaignResponse ret = service.updateCampaign(parameters);
	...
	public static void main(String[] args) throws Throwable {
		UpdateCompaignExample example = new UpdateCompaignExample();
		example.updateCampaign();
	}
