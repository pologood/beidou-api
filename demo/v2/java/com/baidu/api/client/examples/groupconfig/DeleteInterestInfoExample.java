...
import com.baidu.api.sem.nms.v2.DeleteInterestInfoRequest;
import com.baidu.api.sem.nms.v2.DeleteInterestInfoResponse;
import com.baidu.api.sem.nms.v2.GroupConfigService;
import com.baidu.api.sem.nms.v2.GroupInterestInfoType;

/**
 * 
 * ClassName: DeleteInterestInfoExample  <br>
 * Function: TODO ADD FUNCTION
 *
 * @author Baidu API Team
 * @date Feb 9, 2012
 */
public class DeleteInterestInfoExample {

	private GroupConfigService service;

	public DeleteInterestInfoExample() {
	...
	public DeleteInterestInfoResponse deleteInterestInfo() {
		// Prepare your parameters.
		DeleteInterestInfoRequest parameters = new DeleteInterestInfoRequest();
		...
		// Invoke the method.
		DeleteInterestInfoResponse ret = service.deleteInterestInfo(parameters);
	...
	public static void main(String[] args) throws Throwable {
		DeleteInterestInfoExample example = new DeleteInterestInfoExample();
		example.deleteInterestInfo();
	}
