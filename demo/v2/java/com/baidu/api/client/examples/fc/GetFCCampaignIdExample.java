...
/**
 * 
 * ClassName: GetFCCampaignIdExample  <br>
 * Function: TODO ADD FUNCTION
 *
 * @author Baidu API Team
 * @date Apr 20, 2012
 */
public class GetFCCampaignIdExample {

	private FCService service;

	public GetFCCampaignIdExample() {
	...
	public GetFCCampaignIdResponse getFCCampaignId() {
		// Prepare your parameters.
		GetFCCampaignIdRequest parameters = new GetFCCampaignIdRequest();
		// Invoke the method.
		GetFCCampaignIdResponse ret = service.getFCCampaignId(parameters);
	...
	public static void main(String[] args) throws Throwable {
		GetFCCampaignIdExample example = new GetFCCampaignIdExample();
		example.getFCCampaignId();
	}
