 ...
 *       &lt;sequence>
 *         &lt;element name="regions" type="{https://api.baidu.com/sem/nms/v2}RegionType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getAllRegionResponse")
public class GetAllRegionResponse {

    protected List<RegionType> regions;
    ...
    public List<RegionType> getRegions() {
        if (regions == null) {
            regions = new ArrayList<RegionType>();
        }
        return this.regions;
    }
