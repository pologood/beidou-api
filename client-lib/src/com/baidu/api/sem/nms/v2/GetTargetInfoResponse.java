 ...
 *       &lt;sequence>
 *         &lt;element name="targetInfos" type="{https://api.baidu.com/sem/nms/v2}TargetInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getTargetInfoResponse")
public class GetTargetInfoResponse {

    protected List<TargetInfoType> targetInfos;
     ...
     * 
     */
    public List<TargetInfoType> getTargetInfos() {
        if (targetInfos == null) {
            targetInfos = new ArrayList<TargetInfoType>();
        }
