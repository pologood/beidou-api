...
/**
 * ClassName: AddRegionRequest
 * Function: 添加投放地域请求
 *
 * @author Baidu API Team
 * @date 2012-4-1
 */
public class AddRegionRequest implements Serializable, ApiRequest {
    private String version;
	
	private static final long serialVersionUID = -8878336715283577902L;
